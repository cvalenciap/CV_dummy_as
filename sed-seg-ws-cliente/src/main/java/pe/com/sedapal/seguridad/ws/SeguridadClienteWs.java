...
public class SeguridadClienteWs {
	...
	public Retorno olvidarClaveWs(String urlWs, String usuario) {
	...
	public Retorno autenticacionUsuarioWs(String urlWs, String usuario, int codSistema, String clave) {
	...
	public Retorno logoutWs(String urlWs, String token) {
	...
	public Retorno autenticacionUsuarioCompletaWs(String urlWs, String usuario, String ip, String token, int codSistema) {
	...
	public List<SistemaModuloOpcionBean> obtenerMenueWs(String urlWs, String usuario, int codSistema) {
	...
	public Retorno actualizarClaveWs(String urlWs, String usuario, String claveActual, String nuevaClave, String nuevaClaveR) {
	...
	public List<String> obtenerPermisosWs(String urlWs, String usuario) {
	...
	private String getPeticionLogoutWs(String token) {
		StringBuffer buffer = new StringBuffer(2048);
...
//	inicio adecuacion seguridad2
	public Retorno autenticacionUsuarioActWs(String urlWs, String usuario, int codSistema, String clave) {
	...
	public Retorno autenticacionUsuarioCompletaActWs(String urlWs, String usuario, String ip, String token, int codSistema, int codPerfil) {
	...
	public List<SistemaModuloOpcionBean> obtenerMenuActWs(String urlWs, String usuario, int codSistema, int codPerfil) {
	...
	public List<String> obtenerPermisosActWs(String urlWs, String codUsuario, Integer codSistema, Integer codPerfil) {
	...
	public Retorno validarTokenWs(String urlWs, String token) {
	...
	public TrabajadorBean obtenerTrabajadorWs(String urlWs, String codUsuario) {
